        ...
        <div className="about-page">
            <div className="full-screen-section d-flex justify-content-center align-items-center text-center">
                <div className="overlay">
                    ...
                    <p className="lead mx-auto" style={{ maxWidth: "70%" }}>
                        F Store is your one-stop shop for all your needs. We provide high-quality products at competitive prices.
                        Our mission is to deliver exceptional value and service to our customers.<br/> At F Store, we believe in offering
                        ...
                        works tirelessly to ensure that every product meets our stringent quality standards, so you can shop with confidence.<br />
            ...
            <div className="dark-section py-5 text-center">
                ...
                <p className="lead mx-auto" style={{ maxWidth: "70%" }}>
                    ...
                    dedicated customer base.<br/> Our journey began with a simple idea: to make shopping more accessible and enjoyable
                    for everyone. We have since expanded our offerings, constantly innovating and adapting to the latest market trends
                    to ensure that our customers always find what they are looking for.<br/> From humble beginnings to becoming a household name,
